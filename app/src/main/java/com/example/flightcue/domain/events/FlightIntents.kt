...
/**
 * Android broadcast contract for flight events.
 *
 * These ACTION_* strings are stable public identifiers.
 * Receivers can listen for them to react when FlightCue detects or marks a flight.
 */
object FlightIntents {
    ...
    // Shared extras for both actions
